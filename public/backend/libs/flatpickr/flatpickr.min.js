/* flatpickr v4.6.9,, @license MIT */ ! function(e, t) {
    ...
    function E(p, v) {
        ...
        function U() {
            ...
            // Xử lý dropdown tháng
            if (w.config.showMonths > 1 || "static" === w.config.monthSelectorType) {
                e = s("span", "cur-month");
            } else {
            ...
            // Tạo dropdown cho năm thay vì input
            w.yearsDropdownContainer = s("select", "flatpickr-yearDropdown-years");
            w.yearsDropdownContainer.setAttribute("aria-label", w.l10n.yearAriaLabel);
        
            // Thêm danh sách năm vào dropdown với class "flatpickr-yearDropdown-year"
            for (var year = (w.config.minDate ? w.config.minDate.getFullYear() : 1900); 
                 year <= (w.config.maxDate ? w.config.maxDate.getFullYear() : 2100); 
                 year++) {
                var option = document.createElement("option");
                option.value = year;
                option.textContent = year;
                option.classList.add("flatpickr-yearDropdown-year"); // Thêm class vào option
                w.yearsDropdownContainer.appendChild(option);
            }
        
            w.yearsDropdownContainer.value = w.currentYear; // Set năm hiện tại
        
            A(w.yearsDropdownContainer, "change", function (e) {
                var selectedYear = parseInt(g(e).value, 10);
                w.changeYear(selectedYear);
                pe("onYearChange");
            });
        
            var o = s("div", "flatpickr-current-month");
            o.appendChild(e);
            o.appendChild(w.yearsDropdownContainer);
            ...
            return {
                container: t,
                yearElement: w.yearsDropdownContainer,
                monthElement: e
            };
        }
