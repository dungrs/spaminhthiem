const Attribute = {
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status === 'success') {
                    localStorage.setItem("attributeMessage", response.message);
    ...
    bindStoreAndUpdateEntityHandler: function () {
        $(document).on('click', '.submitButton', function (e) {
            ...
            let url = id ? `/ajax/attribute/update/${id}/${language_id}` : '/ajax/attribute/create';
            Attribute.submitFormData(url);
        });
    },

    sendDataFilter: function (page = 1) {
        if (!window.location.pathname.includes('/attribute/index')) {
            return;
        }
        ...
        $.ajax({
            ...
            success: function (response) {
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a href="${Config.baseUrl}/attribute/edit/${item.id}/${item.language_id}" class="dropdown-item edit-button-modal">
                ...
                HT.openChangeStatus();
                HT.handleDeleteRequest(".delete-btn", "/ajax/attribute/delete", Attribute);
    ...
    attachPaginationEvent: function () {
        $(document).on('click', '.pagination .page-link', function (e) {
            ...
            Attribute.sendDataFilter(HT.currentPage);
        });
    },
...
$(document).ready(function () {
    Attribute.bindStoreAndUpdateEntityHandler();
    Attribute.sendDataFilter();
    Attribute.attachFilterEvent();
    Attribute.attachPaginationEvent();
    HT.showStoredMessage("attributeMessage", "/attribute/index");
    HT.attachFilterEvent(Attribute);
