        ...
        <div class="bg-white rounded shadow-sm p-4">
            ...
            <form action="{{ route('getOrder') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="code" value="{{ $data['code'] ?? '' }}" class="form-control rounded-pill px-4" placeholder="Nhập mã đơn hàng của bạn">
                </div>

                <div class="d-grid">
                    <button type="submit" class="btn btn-danger rounded-pill py-2">Tra Cứu</button>
                </div>
            </form>
        </div>
                        ...
                        <div class="col-md-8">
                            <div class="timeline">
                                ...
                                <div class="timeline-step {{ $data['order']->payment === 'paid' ? 'completed' : ($data['order']->payment === 'unpaid' ? 'active' : '') }}">
                                    <div class="timeline-icon {{ $data['order']->payment === 'paid' ? 'bg-success' : ($data['order']->payment === 'unpaid' ? 'bg-danger' : 'bg-warning') }} text-white">
                                ...
                                <div class="timeline-step {{ $data['order']->delivery !== 'pending' ? 'completed' : ($data['order']->delivery === 'delivery' ? 'active' : '') }}">
                                    <div class="timeline-icon {{ $data['order']->delivery !== 'pending' ? 'bg-success' : ($data['order']->delivery === 'delivery' ? 'bg-danger' : '') }} text-white">
